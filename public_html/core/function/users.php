...
function submit_workout($user_id, $time) {
	mysql_query("INSERT INTO `users` ($workout) VALUES ($time) WHERE `user_id` = $user_id");
}
...
function register_user($register_data){
	...
	http://samofit.com/activate.php?email=" . $register_data['email'] . "&email_code=" . $register_data['email_code'] . " \n\n Thanks!
	");
}
