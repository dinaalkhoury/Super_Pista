...
if(isset($_POST['submit'])){
	...
	$total		=intval($pushup1) + intval($squat1) + intval($inchworm1) + intval($march1) + intval($pushup2) + intval($squat2) + intval($inchworm2) +   		intval($march2) + intval($pushup3) + intval($squat3) + intval($inchworm3) + intval($march3) + intval($pushup4) + intval($squat4) + intval(     
		$inchworm4) + intval($march4) + intval($pushup5) + intval($squat5) + intval($inchworm5) + intval($march5);
